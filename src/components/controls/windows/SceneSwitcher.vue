...
const submitForm = async () => {
  ...
  try {
    ...
    if (selectedIndustry.value === 'steel') {
      // 钢铁行业使用内部路由跳转
      console.log(`跳转到钢铁行业仪表板: ${selectedIndustryInfo.route}`)
      ...
      // 其他行业跳转到5173端口的外部地址
      console.log(`跳转到${selectedIndustryInfo.name}行业外部系统: ${selectedIndustryInfo.route}`)
...
.industry-card {
  position: relative;
  background: linear-gradient(135deg, rgba(18, 15, 30, 0.6), rgba(28, 25, 40, 0.4));
  ...
  &::before {
    ...
    border-radius: 12px;
    padding: 2px;
    background: linear-gradient(45deg, rgba(138, 43, 226, 0.3), rgba(80, 250, 123, 0.2), rgba(138, 43, 226, 0.3));
  ...
  &:hover {
    ...
    background: linear-gradient(135deg, rgba(18, 15, 30, 0.8), rgba(28, 25, 40, 0.6));
  ...
  &.selected {
    ...
    background: linear-gradient(135deg, rgba(138, 43, 226, 0.1), rgba(80, 250, 123, 0.05));
    box-shadow:
      0 0 25px rgba(138, 43, 226, 0.3),
      0 0 15px rgba(80, 250, 123, 0.2);
...
.radio-label {
  ...
  &::after {
    ...
    height: 8px;
    border-radius: 50%;
    background: linear-gradient(135deg, rgba(138, 43, 226, 1), rgba(80, 250, 123, 0.8));
