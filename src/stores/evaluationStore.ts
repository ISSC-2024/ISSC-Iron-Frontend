    ...
    children: [
      {
        ...
        name: '基础设施智能化程度',
        children: [
          { id: '1-1-1', name: '炼铁-炼钢-轧钢全流程自动化控制率(%)', value: '', editable: true },
          { id: '1-1-2', name: '关键设备及产线传感器覆盖率(%)', value: '', editable: true },
          { id: '1-1-3', name: '能源及工业介质管网监测数据上传频次(次/天)', value: '', editable: true },
        ],
      },
      {
        id: '1-2',
    ...
    children: [
      {
        ...
        name: '碳排放控制与资源循环利用',
        children: [
          { id: '2-1-1', name: '主要工序碳排放实时监测覆盖率(%)', value: '', editable: true },
          { id: '2-1-2', name: 'CO₂捕集与利用/封存率(CCUS)(%)', value: '', editable: true },
          { id: '2-1-3', name: '焦炉煤气、钢渣等副产物在线回收利用率(%)', value: '', editable: true },
        ],
      },
      {
        id: '2-2',
        name: '清洁能源与绿色技术应用',
        children: [
          { id: '2-2-1', name: '绿电及其他清洁能源使用占比(%)', value: '', editable: true },
          { id: '2-2-2', name: '采用氢冶金、薄带连铸等绿色工艺产线占比(%)', value: '', editable: true },
          { id: '2-2-3', name: '低碳/零碳钢产品出货占比(%)', value: '', editable: true },
        ],
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: '安全监测与应急响应能力',
        children: [
          { id: '3-2-1', name: '煤气、高温熔融金属等关键危险源在线监测覆盖率(%)', value: '', editable: true },
          { id: '3-2-2', name: '安全报警平均响应时间(秒)', value: '', editable: true },
          { id: '3-2-3', name: '应急预案数字化与演练频次(次/季度)', value: '', editable: true },
        ],
      },
    ],
  },
...
const DEFAULT_EXPERT_DATA: FullExpertInfo[] = [
  {
    ...
    desc: '钢铁行业智能化系统专家，擅长高炉、转炉、轧机等核心装备的先进过程控制（APC）与全流程生产优化调度（MES）。',
    prompt:
      '你是一位在钢铁流程工业领域深耕20年的工业智能化系统专家，精通从炼铁、炼钢到轧钢的全流程工艺与控制模型。你擅长DCS/PLC系统架构、MES/SCADA应用部署与OT-IT融合。你对钢铁园区级别的传感网络、工业边缘计算与能源介质智能管网有深入理解，尤其关注生产全流程的数字化闭环与数据互通性。请从"智能化管理水平"出发，结合钢铁流程控制与数据系统集成原理，评价该产业园在关键工艺自动化、设备联网、数据同步频次等方面的智能运行能力。请依据指标反映的系统完备性、实时性与稳定性，为其智能化成熟度打分，并指出可能的短板与优化路径。',
  },
  {
    id: '3',
    name: '王工程师',
    avatar: '/images/experts/default-avatar.png',
    desc: '钢铁行业低碳工艺与碳管理专家，专注于高炉-转炉长流程与电炉短流程的节能降碳技术、氢冶金、CCUS等前沿领域。',
    prompt:
      '你是一位钢铁行业低碳工艺与碳管理专家，专注于煤气化、焦炉煤气制氢、碳捕集与资源梯级利用技术。在园区绿色转型与碳资产监控平台建设方面具有深厚的工程与政策研究基础，熟悉钢铁全流程碳排放实时监测、绿色产线认证与碳足迹核算机制。以"绿色低碳发展水平"为切入点，请评价该园区在碳排放控制、清洁能源利用及副产物回收方面的系统智能化能力。请参考实时监测覆盖率、CCUS效率、绿色工艺产线与低碳钢产品占比等指标，判断该园区在低碳高值路径中的智能化支撑程度与改进方向。',
  },
  {
    id: '4',
    name: '陈研究员',
    avatar: '/images/experts/default-avatar.png',
    desc: '钢铁园区运营安全与产业协同机制专家，在钢化联产、跨企业物料循环与安全生产一体化管理方面经验丰富。',
    prompt:
      '你是一名钢铁园区运营安全与产业协同机制专家，拥有跨园区应急联动机制设计、安全数据实时接入体系建设以及共生网络的运营优化经验。擅长从产业流通与安全监控的融合视角分析工业互联网络的风险与协同效率。请基于"产业协同创新能力"视角，重点评估园区在铁水、钢坯、工业气体等物料跨企业直供、共享环保设施使用、煤气与高温熔融金属等重大危险源在线监控与应急响应机制方面的智能化水平。结合物料交换数据频度、安全数据覆盖率与响应速度等指标，判断该园区在高密度钢铁协同系统中的安全可控性与协同效率。',
  },
  {
    id: '5',
    name: '李博士',
